# -*- coding: utf-8 -*-
#
# plotcontext documentation build configuration file, created by
...
htmlhelp_basename = 'plotcontextdoc'
...
latex_documents = [
  ('index', 'plotcontext.tex', u'plotcontext Documentation',
...
man_pages = [
    ('index', 'plotcontext', u'plotcontext Documentation',
...
texinfo_documents = [
  ('index', 'plotcontext', u'plotcontext Documentation',
   u'Matplotlib developers', 'plotcontext', 'One line description',
   'Miscellaneous'),
]
